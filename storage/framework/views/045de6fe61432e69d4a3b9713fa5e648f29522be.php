<?php if(Session::has('success')): ?>
    <div class="container-xxl" id="kt_content_container">
        <div class="alert alert-dismissible bg-success me-3 text-white d-flex flex-column flex-sm-row p-5 mb-10">
            ...
            <div class="me-3">&nbsp;<?php echo e(Session::get('success')); ?></div>
        </div>
    </div>
...
<div class="container-xxl" id="kt_content_container">
    <div class="alert alert-dismissible bg-danger me-3 text-white d-flex flex-column flex-sm-row p-5 mb-10">
        ...
        <div class="me-3">&nbsp;<?php echo e(Session::get('error')); ?></div>
    </div>
</div>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\dynamicforms\resources\views/partials/alerts/message.blade.php ENDPATH**/ ?>