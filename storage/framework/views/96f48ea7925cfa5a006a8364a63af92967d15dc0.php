				...
				<div id="kt_aside" class="aside overflow-visible pb-5 pt-5 pt-lg-0" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'80px', '300px': '100px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo py-8" id="kt_aside_logo">
						...
						<a href="<?php echo e(route('home')); ?>" class="d-flex align-items-center">
							<img alt="Logo" src="<?php echo e(asset('assets/media/logos/logo.svg')); ?>" class="h-45px logo" />
						</a>
						<!--end::Logo-->
					</div>
					<!--end::Brand-->
					<!--begin::Aside menu-->
					<?php echo $__env->make('layouts.aside.__tab-contents._base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					<!--end::Aside menu-->
					<!--begin::Footer-->
				...
				<!--end::Aside-->
<?php /**PATH D:\xampp\htdocs\dynamicforms\resources\views/layouts/aside/_base.blade.php ENDPATH**/ ?>