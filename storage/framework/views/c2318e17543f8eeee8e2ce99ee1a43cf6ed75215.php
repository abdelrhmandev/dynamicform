...
<div class="toolbar py-2" id="kt_toolbar">
	...
	<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
		<!--begin::Page title-->
		<?php echo $__env->make('layouts.header._page-title', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<!--end::Page title-->
		<!--begin::Action group-->
...
<!--end::Toolbar--><?php /**PATH D:\xampp\htdocs\dynamicforms\resources\views/layouts/topbar/_base.blade.php ENDPATH**/ ?>