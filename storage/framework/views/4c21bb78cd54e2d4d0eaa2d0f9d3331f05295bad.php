<div id="kt_header" style="" class="header  align-items-stretch">
	...
	<div class=" container-fluid  d-flex align-items-stretch justify-content-between">
	   ...
	   <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
		  ...
		  <img alt="Abdo" src="<?php echo e(asset('assets/media/logos/logo.svg')); ?>" class="h-25px"/>
		  </a>
	   </div>
	   <!--end::Mobile logo-->
	   <!--begin::Wrapper-->
		  ...
		  <div class="d-flex align-items-stretch flex-shrink-0">
			 ...
			 <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
				...
				<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
				   <img src="<?php echo e(asset('assets/media/avatars/blank.png')); ?>" alt="image"/>
				</div>
				...
				<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
				   ...
				   <div class="menu-item px-3">
					  <div class="menu-content d-flex align-items-center px-3">
						 ...
						 <div class="symbol symbol-50px me-5">
							<img alt="Abdo" src="<?php echo e(asset('assets/media/avatars/blank.png')); ?>"/>
						 </div>
						 <!--end::Avatar-->
						 <!--begin::Username-->
						 <div class="d-flex flex-column">
				   ...
				   <div class="menu-item px-5">
						<a href="profile" class="menu-link px-5"><?php echo e(__('site.profile')); ?></a>
					  </a>
				   </div>
				   <!--end::Menu item-->
				   <!--begin::Menu item-->
				   ...
				   <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
					...
					<a href="#" class="menu-link px-5">
						<span class="menu-title position-relative"><?php echo e(__('site.languages')); ?> 
						<span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
						<img class="w-15px h-15px rounded-1 ms-2" src="<?php echo e(asset('assets/media/flags/' . app()->getLocale() . '.svg')); ?>" alt="" /></span></span>
					</a>
					  <!--begin::Menu sub-->
