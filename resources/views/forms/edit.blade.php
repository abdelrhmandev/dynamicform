                                            ...
                                            @foreach ($fields as $field)
                                                <tr id="{{ $field->id}}">
                                                 ...
                                                 <td>
                                                    ...
                                                    <td>
                                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                                            <input value="1" class="form-check-input" type="checkbox" name="is_required[{{ $field->id }}]" id="required{{ $field->id }}"
                                                            
                                                            @foreach($row->fields as $getFormFieldRequired) 
                                                            
                                                            @if($field->id == $getFormFieldRequired->pivot->field_id && $getFormFieldRequired->pivot->is_required == 1)
                                                             checked="checked"
                                                              @endif
