                ...
                <div class="card card-flush py-0">
                                                    ...
                                                    <tr>
                                                            ...
                                                            <div class="fv-row fl" id="{{ $field->id }}">
                                                                <label class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        id="field" required
                                                                        data-fv-not-empty___message="فضلا حدد علي الأقل حقل واحد">
                                                        ...
                                                        <td>
                                                            <div
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="1" name="required[{{ $field->id }}]"
                                                                    id="required" /><label class="form-check-label"
                                                                    for="required">
                                                                    <span>نعم</span></label>
                                                            </div>
                                                        </td>
                    ...
                    @else
                        <div class="d-flex flex-column py-10 px-10 px-lg-20 mb-10">
                            ...
                            <a href="{{ route('fields.create') }}" class="btn btn-light-success me-auto"
