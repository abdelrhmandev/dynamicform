<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">TextBox
                </div>
                <div class="text-muted">{{ __('site.notices.textbox') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" id="textbox" value="textbox" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">Text Area
                </div>
                <div class="text-muted">{{ __('site.notices.textarea') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" id="textarea" value="textarea" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">Check Box
                </div>
                <div class="text-muted">{{ __('site.notices.checkbox') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" value="checkbox" id="checkbox" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">File
                </div>
                <div class="text-muted">{{ __('site.notices.file') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" value="file" id="file" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">Numbers
                </div>
                <div class="text-muted">{{ __('site.notices.numbers') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" value="numbers" id="numbers" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">Date
                </div>
                <div class="text-muted">{{ __('site.notices.date') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" id="date" value="date" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">Select
                </div>
                <div class="text-muted">{{ __('site.notices.select') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" id="select" value="select" />
            </label>
        </div>
    </div>
</div>
...
<div class="py-1">
    <div class="py-3 d-flex flex-stack flex-wrap">
        <div class="d-flex align-items-center">
            ...
            <div class="me-3">
                <div class="d-flex align-items-center fw-bold">Radio
                </div>
                <div class="text-muted">{{ __('site.notices.radiobox') }}</div>
            </div>
        </div>
        <div class="d-flex my-3 ms-9">
            <label class="form-check form-check-custom form-check-solid me-5">
                <input class="form-check-input" type="radio" name="type" value="radio" id="radio" />
            </label>
        </div>
    </div>
</div>
