@extends('layouts.app')
@section('title', __('site.elements.add'))
@section('breadcrumbs')
    <h1 class="d-flex align-items-center text-gray-900 fw-bold my-1 fs-3">{{ __('site.elements.list') }}</h1>
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('site.elements.add') }}</li>
    </ul>
@stop
...
@section('content')
    <div id="kt_content_container" class="container-xxl">
        <form id="AddElement" data-route-url="{{ $storeRoute }}" class="form d-flex flex-column flex-lg-row"
                        ...
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="fv-row fl">
                                        <label class="required form-label"
                                            for="display">{{ __('site.formelements.name') }}</label>
                                        <input placeholder="{{ __('site.formelements.name') }}" type="text"
                                            id="element_display" name="element_display" class="form-control mb-2" required
                                            data-fv-not-empty___message="{{ __('site.required_field')}}" />
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="fv-row fl">
                                        <label class="required form-label"
                                            for="title-">{{ __('site.formelements.code') }}</label>
                                        <input placeholder="{{ __('site.formelements.code') }}" type="text"
                                            id="element_name" name="element_name" class="form-control mb-2" required
                                            data-fv-not-empty___message="{{ __('site.required_field')}}"
                                ...
                                <div class="col-xl-4">
                                    <div class="fv-row fl">
                                        <label class="required form-label"
                                            for="title-">{{ __('site.required_field') }}</label>
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input class="form-check-input w-45px h-30px" type="checkbox" id="element_is_required"
                                                value="1" name="element_is_required" />
                                            <label class="form-check-label" for="allowmarketing"></label>
                                            {{ __('site.required_fill') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <label
                                            ...
                                            <span class="svg-icon svg-icon-4x me-4">
                                                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 506.49">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        <div class="fw-semibold">
                                            <h4 class="text-gray-900 fw-bold">وضع قيود علي أمتداد الملف المراد أرفاقه</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body pt-0">
                                    <div id="kt_create_new_upload_type">
                                        <div class="py-1">
                                            <div class="py-3 d-flex flex-stack flex-wrap">
                                                <div class="d-flex align-items-center collapsible toggle"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#kt_create_new_upload_type_1">
                                                    <div class="me-3">
                                                        <div class="d-flex align-items-center fw-bold">
                                                            {{ __('site.images') }} , {{ __('site.upload_only_images') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex my-3 ms-9">
                                                    <label class="form-check form-check-custom form-check-solid me-5">
                                                        <input class="form-check-input" type="radio" value="images"
                                                            name="upload_type" checked="checked" />
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="py-1">
                                            <div class="py-3 d-flex flex-stack flex-wrap">
                                                <div class="d-flex align-items-center collapsible toggle collapsed"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#kt_create_new_upload_type_2">
                                                    <div class="me-3">
                                                        <div class="d-flex align-items-center fw-bold">
                                                            {{ __('site.docs') }} , {{ __('site.upload_only_docs') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex my-3 ms-9">
                                        ...
                                        <div class="py-1">
                                            <div class="py-3 d-flex flex-stack flex-wrap">
                                                <div class="d-flex align-items-center collapsible toggle collapsed"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#kt_create_new_upload_type_3">
                                                    <div class="me-3">
                                                        <div class="d-flex align-items-center fw-bold">القبول بأي نوع ملف
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex my-3 ms-9">
...
<script src="{{ asset('assets/js/custom/handleFormSubmit.js') }}"></script>
    ...
    KTUtil.onDOMContentLoaded(function() {
       handleFormSubmitFunc('AddElement');
    });
        var $class1 = $('.checkbox');
        var $class2 = $('.select');
        var $class3 = $('#radio');
