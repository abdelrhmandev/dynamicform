@extends('layouts.app')
@section('title', 'أضافه عنصر مدخل الي الأستمارة')
@section('breadcrumbs')
    <h1 class="d-flex align-items-center text-gray-900 fw-bold my-1 fs-3">عناصر مدخلات الأستمارة</h1>
    <span class="h-20px border-gray-200 border-start mx-3"></span>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
        <li class="breadcrumb-item text-muted"><a href="{{ route('home') }}" class="text-muted text-hover-primary">الرئيسيه</a>
        </li>
        <li class="breadcrumb-item"><span class="bullet bg-gray-200 w-5px h-2px"></span></li>
        <li class="breadcrumb-item text-dark">أضافه مدخل الي الأستمارة</li>
    </ul>
@stop
@section('content')
    <div id="kt_content_container" class="container-xxl">
        <form id="Add" data-route-url="" class="form d-flex flex-column flex-lg-row"
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex flex-column gap-5">
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="fv-row fl">
                                        <label class="required form-label" for="title-">الأسم الذي سيظر به الحقل</label>
                                        <input placeholder="sdsdas" type="text" id="title_" name="title_"
                                            class="form-control mb-2" required data-fv-not-empty___message="dsadsa"
                                            value="sss" />
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="fv-row fl">
                                        <label class="required form-label" for="title-">الأسم البرمجي للحقل</label>
                                        <input placeholder="sdsdas" type="text" id="title_" name="title_"
                                            class="form-control mb-2" required data-fv-not-empty___message="dsadsa"
                                            value="sss" />
                                ...
                                <div class="col-xl-4">
                                    <div class="fv-row fl">
                                        <label class="required form-label" for="title-">هل الحقل مطلوب ؟</label>
                            ...
                            <div class="row">
                                <div class="card-title">
                                   <h2 class="fw-bold">يرجي تحديد نوع الحقل</h2>
                                </div>                                 
                                    <div class="col-xl-4">
                                        <div class="pb-10">
                                            <input type="radio" class="btn-check" name="element_type"
                                                id="textbox" value="textbox" checked="checked">
                                            <label
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في تجميع معلومات نصية
                                                        قصيرة من المستخدمين.</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pb-10">
                                            ...
                                            <label
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في تجميع نصوص كبيرة
                                                        من المستخدمين </span>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-xl-5">
                                        <div class="pb-10">
                                            <input type="radio" class="btn-check checkbox" name="element_type" value="checkbox"
                                                id="checkbox" />
                                            <label
                                                class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center mb-5"
                                                for="checkbox">
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في عرض قائمة اختيارات
                                                        للمستخدمين، لجعلهم يختارون منها عنصر أو أكثر.</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pb-10">
                                            ...
                                            <label
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في رفع ملفات من
                                                        المستخدمين.</span>
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="pb-10">
                                            ...
                                            <label
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في أضافه الأرقام
                                                        للمستخدمين.</span>
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="pb-10">
                                            ...
                                            <label
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في أنشاء التواريخ
                                                        للمستخدمين.</span>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="pb-10">
                                            <input type="radio" class="btn-check select" name="element_type" value="select"
                                                id="select" />
                                            <label
                                                class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center mb-5"
                                                for="select">
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في عرض قائمة
                                                        اختيارات للمستخدمين، لجعلهم يختارون منها عنصر أو أكثر.</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pb-10">
                                            ...
                                            <label
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-6"> يُستخدم في عرض قائمة
                                                        اختيارات للمستخدمين، لجعلهم يختارون منها عنصر واحد فقط.</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
...
<div class="row">
    <div class="card-title">
        <h2>ملئ الحقل المختار بالبيانات</h2>
    </div>  
