                    ...
                    <div class="card-body pt-5">
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-5">
                                    <div class="pb-10">
                                        <input type="radio" class="btn-check checkbox" name="type"
                                ...
                                <div class="col-xl-6">
                                    <div class="pb-10">
                                        <input type="radio" class="btn-check select" name="type"
        ...
        <table id="kt_create_new_custom_fields"
            ...
            <thead>
                <tr class="text-start fw-bold fs-7 text-uppercase gs-0">
                    <th class="pt-0">
                        <div class="fv-row fl">
                        <label class="required form-label" for="fillable_display">أسم العنصر المراد ملؤه </label>
                        </div>
                    ...
                    <th class="pt-0">
                        ...
                        <div class="fv-row fl">
                        <label class="required form-label" for="fillable_value">قيمه العنصر المراد ملؤه </label> 
                        <small
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="fv-row fl">
                            <input type="text" class="form-control form-control-lg" placeholder="أسم العنصر المراد ملؤه" required data-fv-not-empty___message="{{ __('site.required_field') }}" name="fillable_display[]"/>
                        </div>
                    </td>
                    <td>
                        <div class="fv-row fl">
                            <input type="text" class="form-control form-control-lg" placeholder="قيمه العنصر المراد ملؤه" required data-fv-not-empty___message="{{ __('site.required_field') }}" name="fillable_value[]"/>
                        </div>
                    </td>
                    <td class="text-end">
                        <button type="button"
