                    ...
                    <div class="card-body pt-2">
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class="fv-row fl">
                                ...
                                <input placeholder="مثال الأسم , رقم الهويه .... " type="text" id="title"
                            ...
                            @if($row->JsonExtractValidationRules('callback') == 'Validate_SA_Id_Number')
                            <input type="hidden" name="typeIdNumber" value="1">
                                    ...
                                    <div class="fw-semibold">
                                        ...
                                        <div class="fs-6 text-gray-700">
                                            <p>
                                                ...
                                                - 
                                                رقم الهوية مكون من 10 أرقام
                                                -
                                                رقم الهوية لابد ان يبدأ (1 أو 2)
                                            </p>
                                            و فقا للقانون السعودي
                            ...
                            @elseif($row->JsonExtractValidationRules('callback') == 'Validate_SA_Phone_Number')
                            <input type="hidden" name="typePhoneNumber" value="1">
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6 mb-5">
                                <span class="svg-icon svg-icon-2tx svg-icon-warning me-4">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-semibold">
                                        ...
                                        <div class="fs-6 text-gray-700">
                                            <p>
                                                لابد من اضافة رقم الجوال مكون من 10 ارقام
                                                - 
                                                لابد أن يبدأ رقم الجوال برقم 05
                                                -
                                                رقم الجوال مكون من 10 أرقام فقط لا أقل و لا أكثر
                                            </p>
                                            و فقا للقانون السعودي                
                                        </div>
                                    </div>
                            ...
                            <div class="fv-row fl flex-column mb-2">
                                <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                            ...
                            <div class="d-flex flex-column mb-5">
                                <div class="me-5">
                                    ...
                                    <div class="fs-7 fw-semibold text-muted">يجب ملأ الحقل بكلمات عربيه ليست اي شيء أخر</div>
                                </div>
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="attribute" value="arabic_letters_only"
                                ...
                                <div class="notice d-flex bg-light-success rounded border-success border border-dashed p-6">                           
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">                                   
                                        <div class="fw-semibold">
                                            <h4 class="text-gray-900 fw-bold">برجاء الأنتباه الي</h4>
                                            <div class="fs-6 text-gray-700">
                                                  هذا الحقل يحتوي علي ملأ بالبيانات
                                            </div>
                                        </div>                                  
                                    </div>                               
                                </div>
                                <div class="card-toolbar mt-2">
                                    <div class="d-flex justify-content-end" data-kt-table-toolbar="base"></div>                                       
                                  ...
                                  <div class="mt-5">
                                    <table id="kt_create_new_custom_fields" class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-7 gs-7">
                                    <thead>
...
@if (in_array($row->type, ['radio', 'select','checkbox']))
    ...
    KTUtil.onDOMContentLoaded(function () {
        loadDatatable('fillable','{{ $editRoute }}',dynamicColumns,'','1');
    });
    </script>
@endif
