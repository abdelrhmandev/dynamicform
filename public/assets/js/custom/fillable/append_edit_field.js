"use strict";
var KTFillableEditField = (function () {
    var t,
        e,
        n = function () {
            ...
            (t = document.getElementById("kt_create_new_custom_fields")),
                ...
                KTUtil.on(t, '[data-kt-action="field_remove"]', "click", function (t) {
                    ...
                    Swal.fire({
                        ...
                        t.value
                            ? Swal.fire({ text: "لقد تم الحذف!.", icon: "success", buttonsStyling: !1, confirmButtonText: "حسنا!", customClass: { confirmButton: "btn fw-bold btn-primary" } }).then(function () {
                                  e.row($(n)).remove().draw();
                              })
                            : "cancel" === t.dismiss && Swal.fire({ text: "لم يتم الحذف.", icon: "error", buttonsStyling: !1, confirmButtonText: "حسنا!", customClass: { confirmButton: "btn fw-bold btn-primary" } });
                    });
                });
        },
    };
