...
!(function (e) {
    e.fn.imageUploader = function (t) {
        ...
        let o = function () {
            ...
            g = function (e) {
                FileExtensionsMsg = `الأمتدادات المسوحه فقط: "${a.settings.extensions.join('", "')}"`;
                return !(a.settings.extensions.indexOf(e.name.replace(new RegExp("^.*\\."), ".")) < 0) || (createCustomAlert(FileExtensionsMsg), !1);
            },
            c = function (e) {
                FileMimeTypesMsg = `الأمتدادات المسوحه فقط "${a.settings.mimes.join('", "')}"`;
                return !(a.settings.mimes.indexOf(e.type) < 0) || (createCustomAlert(FileMimeTypesMsg), !1);
            },
            f = function (e) {
                FileMaxsizeMsg = `حجم الملف أكبر من الحد المسموح به ${a.settings.maxSize / 1024 / 1024}Mb`;
